...
class UserApi extends Api{
	 ...
	 */
	public function register($username, $password, $email, $mobile = '', $openid = '', $token = '') {
		return $this->model->register ( $username, $password, $email, $mobile, $openid, $token);
    }
