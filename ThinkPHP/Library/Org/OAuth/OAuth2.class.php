...
abstract class OAuth2 {
   ...
   */
  abstract protected function setAccessToken($oauth_token, $user_id, $client_id, $refresh_token, $expires, $scope = NULL);
  ...
  // Function that help grant access tokens for various grant types.
   ...
   * @ingroup oauth2_section_4
   */
  protected function setAuthCode($code, $user_id, $client_id, $redirect_uri, $expires, $scope = NULL) {
  }
